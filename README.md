...
<a name="desc"></a>
## 1. Description
Controlling an alternative High Voltage (as an example we will use 220 volts lamp) from a 5 volts microcontroller. The project is compiled using CCS C Compiler and uses a 16F866 PIC Microcontroller. 
